			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('admin/ganjil1920s2/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url(" admin/ganjil19202/edit") ?>" method="post"
							...
							<div class="form-group">
								...
								value="<?php echo $ganjil19202->jam ?>">
							...
							<div class="form-group">
								...
								value="<?php echo $ganjil19202->status ?>">
