			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('admin/ganjil1819s2/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url(" admin/ganjil18192/edit") ?>" method="post"
							...
							<div class="form-group">
								...
								value="<?php echo $ganjil18192->jam ?>">
							...
							<div class="form-group">
								...
								value="<?php echo $ganjil18192->status ?>">
