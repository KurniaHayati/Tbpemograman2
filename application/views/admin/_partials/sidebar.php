...
<ul class="sidebar navbar-nav">
    ...
    <li class="nav-item dropdown <?php echo $this->uri->segment(2) == 'jadwalajas2' ? 'active': '' ?>">
        <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
            aria-expanded="false">
            <i class="fas fa-fw fa-boxes"></i>
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="<?php echo site_url('admin/ganjil1819s2') ?>">Ganjil 2018/2019</a>
            <a class="dropdown-item" href="<?php echo site_url('admin/genap1819s2') ?>">Genap 2018/2019</a>
            <a class="dropdown-item" href="<?php echo site_url('admin/ganjil1920s2') ?>">Ganjil 2019/2020</a>
            <a class="dropdown-item" href="<?php echo site_url('admin/jadwalajas2') ?>">Genap 2019/2020</a>
        </div>
    </li>
