			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('admin/jadwalajas2/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url(" admin/jadwalaja2/edit") ?>" method="post"
							...
							<div class="form-group">
								...
								value="<?php echo $jadwalaja2->status ?>">
