					...
					<div class="card-body">
						...
						<div class="table-responsive">
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									<?php foreach ($jadwalajas2 as $jadwalaja): ?>
									<tr>
										<td width="150">
										...
										<td width="250">
											<a href="<?php echo site_url('dosen/jadwalajas/edit/'.$jadwalaja->id_jadwal) ?>"
											 class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
											<a onclick="deleteConfirm('<?php echo site_url('dosen/jadwalajas/delete/'.$jadwalaja->id_jadwal) ?>')"
