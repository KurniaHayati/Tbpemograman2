			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('dosen/genap1819s2/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url(" dosen/genap18192/edit") ?>" method="post"
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('jam') ? 'is-invalid':'' ?>"
								 type="text" name="jam" placeholder="Jam" value="<?php echo $genap18192->jam ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('status') ? 'is-invalid':'' ?>"
								 type="text" name="status" placeholder="Status" value="<?php echo $genap18192->status ?>" />
								<div class="invalid-feedback">
